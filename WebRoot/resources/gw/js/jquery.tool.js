				 ...
				 seekTo:function(T,Y,V)
				 {
					 ...
					 if(!V)
					 {
						 ...
						 if(Z&&Z=="p-top-main")
						 {
							 ...
							 if(Q.getIndex()=="0")
							 {
								 B("#p-banner-1.p-selected-view h1").animate({left:"-"+S+"px"},{queue:false,duration:1000})
                              }
							 if(Q.getIndex()=="1")
							 {
								 B("#p-banner-2.p-selected-view h2").animate({left:"-"+S+"px"},{queue:false,duration:1000})
							  }
							 if(Q.getIndex()=="2"){
								 B("#p-banner-3.p-selected-view h2").animate({left:"-"+S+"px"},{queue:false,duration:1000})
							  }
							 if(Q.getIndex()=="3"){
								 B("#p-banner-4.p-selected-view h2").animate({left:"-"+S+"px"},{queue:false,duration:1000})
							  }
							 if(Q.getIndex()=="4"){
								 B("#p-banner-5.p-selected-view h2").animate({left:"-"+S+"px"},{queue:false,duration:1000})
							  }
							 if(Q.getIndex()=="5"){
								 B("#p-banner-6.p-selected-view h2").animate({left:"-"+S+"px"},{queue:false,duration:1000})
							  }
							 if(Q.getIndex()=="6"){
								 B("#p-banner-7.p-selected-view h2").animate({left:"-"+S+"px"},{queue:false,duration:1000})
							  }
							 if(Q.getIndex()=="7"){
								 B("#p-banner-8.p-selected-view h2").animate({left:"-"+S+"px"},{queue:false,duration:1000})
							  }
							 if(Q.getIndex()=="8"){
								 B("#p-banner-9.p-selected-view h2").animate({left:"-"+S+"px"},{queue:false,duration:1000})
							  }
						 }
						 G.trigger(X,[T,Y]);
