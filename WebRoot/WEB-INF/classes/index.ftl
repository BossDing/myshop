...
<html>
	...
	<div class="scroll">
			...
			<!--
	        	<img src="${base}/resources/mobile/images/banner001.jpg">
	            <img src="${base}/resources/mobile/images/sylbt1.jpg">
			-->
				[@ad_position id=610/]
	        ...
	        <div class="nav-index card">
	            <ul>
	                ...
	                <li><a href="${base}/mobile/product/list.jhtml?tagIds=1"><span class="ico ico-th"></span><span class="t"><span>热卖</span></span></a></li>
				             ...
				             [#if (np_index==0)] <div class="col2">[/#if]
				                <div class="row1">
				                    <a href="${base}/mobile${np.path}">
										<span class="imgurl">
											<img src="[#if np.image??]${np.image}[#else]${setting.defaultThumbnailProductImage}[/#if]" style="display: inline;">
