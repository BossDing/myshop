...
<link href="${base}/resources/shop/css/wjl_register.css" rel="stylesheet" type="text/css" />
...
<body>
									...
									<tr>
										...
										<td>
											...
											[#elseif memberAttribute.type == "mobile"]
												<input type="text" name="memberAttribute_${memberAttribute.id}" class="text" maxlength="200" />
											[#elseif memberAttribute.type == "email"]
												<input type="text" name="memberAttribute_${memberAttribute.id}" class="text" maxlength="200" />
	...
	<!--新注册页面-->
	    ...
	    <div id="index_place">您现在的位置： <span>首页</span> > <span>用户注册</span></div>
	<strong style="width:1190px;margin:0px auto; display: block;font-size: 18px;line-height: 40px;">新用户注册</strong>
					...
					<form id="registerForm" action="${base}/register/submit.jhtml" method="post">
						<table>
							...
							<tr>
								...
								<td>
									<input id="mobile" type="text" name="memberAttribute_8" class="text" />
								</td>
							</tr>
							...
							[#if setting.captchaTypes?? && setting.captchaTypes?seq_contains("memberLogin")]
								...
								<td>
										<span class="fieldSet">
											<input type="text" id="captcha" name="captcha" class="text captcha" maxlength="4" autocomplete="off" /></span>
								</td>
							</tr>
							<tr>
									<th>
									...
									<td>
								       <div style="font-size:10px; color:#adadad;">输入下图中的字符，不区分大小写</div>
