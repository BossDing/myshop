...
<link href="${base}/resources/shop/css/preferenceDetail.css" rel="stylesheet" type="text/css" />
...
$().ready(function() {
	...
	$window.scroll(function() {
		...
		if (scrollTop > barTop) {
			...
			$bar.find("li").removeClass("current");
			$bar.css({position: "absolute", top: "745px"});
		}
	});
...
<body style="background:#f8f8f8;">
	...
	<div class="span18 last" style="width:1050px;">
			...
			<div class="info">
				<dl>
					<dt>
						${message("shop.product.inventory")}
					</dt>
					<dd>
						[#if product.stock =="" || product.stock <= 0]
							${message("shop.product.noInventory")}
						[#elseif product.stock >5]
							${message("shop.product.inventoryIsEnough")}
						[#else]
							${message("shop.product.inventoryNervous")}
						[/#if]
					</dd>
				</dl>
				<dl>
				...
				<dl>
					<dt>活动时间:</dt>
					<dd class="time">
						仅剩<span>01</span>天<span>01</span>时<span>01</span>分<span>01</span>秒
					</dd>
				</dl>
			</div>
			[#if !product.isGift]
