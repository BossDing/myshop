...
<head>
	...
	var $headcartcount = $("#headcartcount");

		// 立即预约
	$xq_button.click(function() {
	  document.location.href="${base}/preSellRole/toApply/${preSellRole.id}.jhtml";
	});
	// 商品图片放大镜
	$zoom.jqzoom({
		zoomWidth: 368,
...
<body>
	...
	[#assign products = preSellRole.products /]
        ...
        <div class="apply">
            ...
            <div class="apply_infor">
                <ul>
                    ...
                    <li>
                        <input type="button" class="xq_button" value="立即预约" /></li>
                </ul>
            </div>
        </div>
