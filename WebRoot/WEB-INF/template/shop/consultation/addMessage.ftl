...
<div class="where-big">
  <div id="index_place" style="width:400px;float:left">您的位置：<span>首页</span>><span>个人中心</span>><span>买家留言</span></div>
  <div class="kfdlb">
      <ul>
          <li>分享到：</li>
...
<div class="ziliao-big">
  ...
  [/#if]
      ...
      <form id="messageForm" action="${base}/consultation/saveX.jhtml"  method="post" >
      <div class="zu">
