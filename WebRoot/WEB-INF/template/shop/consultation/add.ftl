...
<body>
	...
	<div class="container consultation" style="width:1190px;">
		<div class="span6">
		...
		<div class="span18 last" style="width:946px;margin-top:25px;">
			<div class="path">
				<ul>
					<li>
			...
			<form style="margin:20px;" id="consultationForm" action="${base}/consultation/save.jhtml" method="post">
