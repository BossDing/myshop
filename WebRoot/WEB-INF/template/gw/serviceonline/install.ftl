						...
						if (message.type == "success") {
							setTimeout(function() {
								 //$("#submit1").prop("disabled", false);
								  window.location.href = "/gw/serviceOnline/install.jhtml";
							}, 3000);
...
<div class="cpzx">
  <div class="cpzx_div zlm_bg">
    <div class="gywjl_dq">目前您在：<a href="/gw/index.jhtml">首页</a> &gt;<a href="/gw/article/glist/838.jhtml">服务支持</a> &gt; 安装预约</div>
    <div class="jrwjl_z">
    	<!--
          ...
          <tbody>
            ...
            <tr>
              <td height="100"><div class="faxq_nav">
                  <div class="fa_lj"><a href="${base}/gw/serviceOnline/repair.jhtml">维修预约</a></div>
			        <div class="fa_lj2"><a href="${base}/gw/serviceOnline/install.jhtml">安装预约</a></div>
                    ...
                    <tbody>
                      ...
                      <tr>
	                   ...
	                   <tr>
                        	...
                        	<td height="36"><input name="productName" id="productSelect" type="text" class="weixiu text" size="25" placeholder="请输入产品型号" /></td>
                      </tr>         
                      <tr>
                      ...
                      <tr>
                        <td height="24" align="right" valign="top"><span class="hong">* </span>要求服务描述：</td>
