	...
	<form id="listForm" action="list.jhtml" method="get">
				...
				<div class="menuWrap">
					...
					<div class="popupMenu">
						<ul id="filterOption" class="check">
							...
							<li class="separator">
								<a href="javascript:;" name="type" val="0"[#if type?? && type=="0"] class="checked"[/#if]>普通订单</a>
							</li>
							<li>
								<a href="javascript:;" name="type" val="1"[#if type?? && type=="1"] class="checked"[/#if]>积分订单</a>
							</li>
						</ul>
					</div>
				</div>
		...
		<table id="listTable" class="list">
			<tr>
				...
				<th>
				    <a href="javascript:;" class="sort" name="type">订单类型</a>
				</th>
				<th>
			...
			<!--11-->
				...
				<!--11-->	
					...
					<td>
					    [#if order.type?? && order.type=="0"]
                          		普通
                        [#elseif order.type?? && order.type=="1"]
                                积分
                        [#else]
                                其他						
						[/#if]
