			...
			<tr class="authorities">
				...
				<td>
					<span class="fieldSet">
                        ...
                        <label>
							<input type="checkbox" name="authorities" value="admin:productFenxiao"[#if role.authorities?seq_contains("admin:productFenxiao")] checked="checked"[/#if] />分销商品
						</label>
                        <label>
							<input type="checkbox" name="authorities" value="admin:productCheck"[#if role.authorities?seq_contains("admin:productCheck")] checked="checked"[/#if] />商品审核
						</label>
						<label>
							<input type="checkbox" name="authorities" value="admin:productInstruction"[#if role.authorities?seq_contains("admin:productInstruction")] checked="checked"[/#if] />产品说明书
						</label>
					</span>
				</td>
			</tr>
				...
				<td>
					<span class="fieldSet">
						...
						<label>
                         ...
                         <label>
							<input type="checkbox" name="authorities" value="admin:memberPoints" [#if role.authorities?seq_contains("admin:memberPoints")] checked="checked"[/#if]/>会员积分规则
						</label>
                        <label>
							<input type="checkbox" name="authorities" value="admin:admin:memberSignRewards" [#if role.authorities?seq_contains("admin:memberSignRewards")] checked="checked"[/#if]/>签到积分奖励
						</label>
						<label>
						...
						<label>
                         ...
                         <label>
							<input type="checkbox" name="authorities" value="admin:leaveWords" [#if role.authorities?seq_contains("admin:leaveWords")] checked="checked"[/#if]/>留言管理
						</label>
                        <label>
							<input type="checkbox" name="authorities" value="admin:joinLeaveWords" [#if role.authorities?seq_contains("admin:joinLeaveWords")] checked="checked"[/#if]/>加盟留言
						</label>
                        <label>
							<input type="checkbox" name="authorities" value="admin:afterBooking" [#if role.authorities?seq_contains("admin:afterBooking")] checked="checked"[/#if]/>维修预约
						</label>
						<label>
							<input type="checkbox" name="authorities" value="admin:afterBookingInstall" [#if role.authorities?seq_contains("admin:afterBookingInstall")] checked="checked"[/#if]/>安装预约
						</label>
                        <label>
							<input type="checkbox" name="authorities" value="admin:serviceSite" [#if role.authorities?seq_contains("admin:serviceSite")] checked="checked"[/#if]/>服务网点
						</label>
                        <label>
							<input type="checkbox" name="authorities" value="admin:serviceExtended" [#if role.authorities?seq_contains("admin:serviceExtended")] checked="checked"[/#if]/>延保服务
						</label>
					</span>
				</td>
			</tr>
			<tr class="authorities">
				...
				<td>
					<span class="fieldSet">
                        ...
                        <label>
							<input type="checkbox" name="authorities" value="admin:warmTips" [#if role.authorities?seq_contains("admin:warmTips")] checked="checked"[/#if]/>温馨提示
						</label>
					</span>
				</td>
			</tr>
				...
				<td>
					<span class="fieldSet">
						<label>
                         ...
                         <label>
							<input type="checkbox" name="authorities" value="admin:trialSetting" [#if role.authorities?seq_contains("admin:trialSetting")] checked="checked"[/#if]/>试用活动设置
						</label>
                        <label>
							<input type="checkbox" name="authorities" value="admin:trialApply" [#if role.authorities?seq_contains("admin:trialApply")] checked="checked"[/#if]/>试用申请管理
						</label>
                        <label>
							<input type="checkbox" name="authorities" value="admin:trialReport" [#if role.authorities?seq_contains("admin:trialReport")] checked="checked"[/#if]/>试用报告管理
						</label>
						<label>
                        ...
                        <label>
							<input type="checkbox" name="authorities" value="admin:groupon" [#if role.authorities?seq_contains("admin:groupon")] checked="checked"[/#if]/>团购管理
						</label>
					</span>
				</td>
			</tr>
			...
			<tr class="authorities">
				...
				<td>
					<span class="fieldSet">
                        ...
                        <label>
							<input type="checkbox" name="authorities" value="admin:store" [#if role.authorities?seq_contains("admin:store")] checked="checked"[/#if]/>店铺管理
						</label>
						<label>
                        ...
                        <label>
							<input type="checkbox" name="authorities" value="admin:notice" [#if role.authorities?seq_contains("admin:notice")] checked="checked"[/#if]/>站内公告
						</label>
						<label>
