				...
				<td>
					<span class="fieldSet">
						...
						<label>
                         ...
                         <label>
							<input type="checkbox" name="authorities" value="admin:productFenxiao" />分销商品
						</label>
                        <label>
							<input type="checkbox" name="authorities" value="admin:productCheck" />商品审核
						</label>
						<label>
							<input type="checkbox" name="authorities" value="admin:productInstruction" />商品审核
						</label>
					</span>
				</td>
			</tr>
			...
			<tr class="authorities">
				...
				<td>
					<span class="fieldSet">
                        ...
                        <label>
							<input type="checkbox" name="authorities" value="admin:memberPoints" />会员积分规则
						</label>
                        <label>
							<input type="checkbox" name="authorities" value="admin:admin:memberSignRewards" />签到积分奖励
						</label>
						<label>
                        ...
                        <label>
							<input type="checkbox" name="authorities" value="admin:leaveWords" />留言管理
						</label>
                        <label>
							<input type="checkbox" name="authorities" value="admin:joinLeaveWords" />加盟留言
						</label>
                        <label>
							<input type="checkbox" name="authorities" value="admin:afterBooking" />维修预约
						</label>
						<label>
							<input type="checkbox" name="authorities" value="admin:afterBookingInstall" />安装预约
						</label>
                        <label>
							<input type="checkbox" name="authorities" value="admin:serviceSite" />服务网点
						</label>
                        <label>
							<input type="checkbox" name="authorities" value="admin:serviceExtended" />延保服务
						</label>
					</span>
				</td>
			</tr>
			<tr class="authorities">
				...
				<td>
					<span class="fieldSet">
                        ...
                        <label>
							<input type="checkbox" name="authorities" value="admin:warmTips" />温馨提示
						</label>
					</span>
				</td>
			</tr>
			<tr class="authorities">
				...
				<td>
					<span class="fieldSet">
                        ...
                        <label>
							<input type="checkbox" name="authorities" value="admin:trialSetting" />试用活动设置
						</label>
                        <label>
							<input type="checkbox" name="authorities" value="admin:trialApply" />试用申请管理
						</label>
                        <label>
							<input type="checkbox" name="authorities" value="admin:trialReport" />试用报告管理
						</label>
						<label>
                        ...
                        <label>
							<input type="checkbox" name="authorities" value="admin:groupon" />团购管理
						</label>
					</span>
				</td>
			</tr>
			...
			<tr class="authorities">
				...
				<td>
					<span class="fieldSet">
                        ...
                        <label>
							<input type="checkbox" name="authorities" value="admin:store" />店铺管理
						</label>
						<label>
                        ...
                        <label>
							<input type="checkbox" name="authorities" value="admin:notice" />站内公告
						</label>
						<label>
