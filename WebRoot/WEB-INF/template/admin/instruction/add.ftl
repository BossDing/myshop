...
<body>
	<div class="path">
		<a href="${base}/admin/common/index.jhtml">${message("admin.path.index")}</a> &raquo; 添加产品说明书
	</div>
	<form id="inputForm" action="save.jhtml" method="post">
		<table class="input tabContent">
			...
			<tr>
				...
				<td>
					<span class="fieldSet">
						<input type="text" name="url" class="text" maxlength="200" title="${message("admin.product.imageTitle")}" />
