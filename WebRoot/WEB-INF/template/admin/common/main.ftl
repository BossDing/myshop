		...
		<tr>
			...
			<th>
				<div id="nav" class="nav">
					<ul>
						[#list ["admin:product", "admin:productCategory", "admin:parameterGroup", "admin:attribute", "admin:specification", "admin:brand", "admin:productNotify", "admin:productCheck", "admin:productFenxiao", "admin:productInstruction"] as permission]
						...
						[#list ["admin:order", "admin:payment", "admin:refunds", "admin:shipping", "admin:returns", "admin:deliveryCenter", "admin:deliveryTemplate"] as permission]
							...
							[/@shiro.hasPermission]
						[/#list]
						[#list ["admin:member", "admin:memberRank", "admin:memberAttribute", "admin:review", "admin:consultation", "admin:memberPoints", "admin:memberSignRewards", "admin:leaveWords", "admin:joinLeaveWords","admin:afterBooking", "admin:afterBookingInstall", "admin:serviceSite", "admin:serviceExtended"] as permission]
							[@shiro.hasPermission name = permission]
								<li>
							...
							[/@shiro.hasPermission]
						[/#list]
						[#list ["admin:navigation", "admin:article", "admin:articleCategory", "admin:tag", "admin:friendLink", "admin:adPosition", "admin:ad", "admin:template", "admin:cache", "admin:static", "admin:index", "admin:warmTips"] as permission]
							[@shiro.hasPermission name = permission]
								<li>
						...
						[/#list]
						[#--
						[#list ["admin:promotion", "admin:coupon", "admin:seo", "admin:sitemap", "admin:trialSetting", "admin:trialApply", "admin:trialReport", "admin:groupon"] as permission]
							[@shiro.hasPermission name = permission]--]
								<li>
						...
						[#list ["admin:statistics", "admin:sales", "admin:salesRanking", "admin:purchaseRanking", "admin:deposit"] as permission]
							...
							[/@shiro.hasPermission]
						[/#list]
						[#list ["admin:setting", "admin:area", "admin:paymentMethod", "admin:shippingMethod", "admin:deliveryCorp", "admin:paymentPlugin", "admin:storagePlugin", "admin:admin", "admin:role", "admin:message", "admin:log", "admin:store", "admin:notice"] as permission]
							[@shiro.hasPermission name = permission]
								<li>
		...
		<tr>
			<td id="menu" class="menu">
				<dl id="product" class="default">
					...
					[/@shiro.hasPermission]
                    [@shiro.hasPermission name="admin:productFenxiao"]
						<dd>
							<a href="../fenxiao_product/list.jhtml" target="iframe">分销商品</a>
						</dd>
                    [/@shiro.hasPermission]
                    [@shiro.hasPermission name="admin:productCheck"]
						<dd>
							<a href="../product_check/list.jhtml" target="iframe">商品审核</a>
						</dd>
					[/@shiro.hasPermission]
					[@shiro.hasPermission name="admin:productInstruction"]
							<dd>
								<a href="../instruction/list.jhtml" target="iframe">产品说明书</a>
						</dd>
					[/@shiro.hasPermission]
				</dl>
				<dl id="order">
				...
				<dl id="member">
					...
					[/@shiro.hasPermission]
                    [@shiro.hasPermission name="admin:memberPoints"]
						<dd>
							<a href="../member_points/list.jhtml" target="iframe">${message("admin.main.memberPoints")}</a>
						</dd>
                    [/@shiro.hasPermission]
                    [@shiro.hasPermission name="admin:memberSignRewards"]
						<dd>
							<a href="../sign_in_point_rule/list.jhtml?orderProperty=serialSignInTimes&orderDirection=asc" target="iframe">签到积分奖励</a>
						</dd>
                    [/@shiro.hasPermission]
					...
					[/@shiro.hasPermission]
                    [@shiro.hasPermission name="admin:leaveWords"]
						<dd>
							<a href="../leaveWords/list.jhtml?label=1" target="iframe">${message("admin.main.leaveWords")}</a>
						</dd>
                    [/@shiro.hasPermission]
                    [@shiro.hasPermission name="admin:joinLeaveWords"]
						<dd>
							<a href="../leaveWords/listjion.jhtml?label=2" target="iframe">加盟留言</a>
						</dd>
                    [/@shiro.hasPermission]
                    [@shiro.hasPermission name="admin:afterBooking"]
						<dd>
							<a href="../after_booking/list.jhtml?label=1" target="iframe">维修预约</a>
						</dd>
                    [/@shiro.hasPermission]
                    [@shiro.hasPermission name="admin:afterBookingInstall"]
						<dd>
							<a href="../after_booking/list2.jhtml?label=0" target="iframe">安装预约</a>
						</dd>
                    [/@shiro.hasPermission]
                    [@shiro.hasPermission name="admin:serviceSite"]
						<dd>
							<a href="../outlet/list.jhtml" target="iframe">服务网点</a>
						</dd>
                    [/@shiro.hasPermission]
                    [@shiro.hasPermission name="admin:serviceExtended"]
						<dd>
							<a href="../extension/list.jhtml" target="iframe">延保服务</a>
						</dd>
                    [/@shiro.hasPermission]
						[#--<dd>
							<a href="../service_register/list.jhtml" target="iframe">服务登记</a>
						</dd>--]
				</dl>
				<dl id="content">
					...
					[/@shiro.hasPermission]
                    [@shiro.hasPermission name="admin:warmTips"]
						<dd>
							<a href="../warmtips/list.jhtml" target="iframe">温馨提示</a>
						</dd>
                    [/@shiro.hasPermission]
				</dl>
				<dl id="marketing">
                    ...
                    [#--
						<dd>
							<a href="../action/type/list.jhtml" target="iframe">直降策略</a>     
						</dd>
					...
					[#--[/@shiro.hasPermission]--]
						...
						[#--<dd>
							<a href="../sync_promotion/list.jhtml" target="iframe">可同步促销</a>
						</dd>--]
                    [@shiro.hasPermission name="admin:trialSetting"]
						<dd>
							<a href="../trial/list.jhtml" target="iframe">试用活动设置</a>
						</dd>
                    [/@shiro.hasPermission]
					<!--<dd>
							<a href="../experience/list.jhtml" target="iframe">体验中心</a>     
					</dd>
					<dd>
							<a href="../experience_apply/list.jhtml" target="iframe">申请中心</a>     
					</dd>-->
                    [@shiro.hasPermission name="admin:trialApply"]
						<dd>
							<a href="../trial/apply/list.jhtml" target="iframe">试用申请管理</a>     
						</dd>
                    [/@shiro.hasPermission]
                    [@shiro.hasPermission name="admin:trialReport"]
						<dd>
							<a href="../trial/report/list.jhtml" target="iframe">试用报告管理</a>     
						</dd>
                    [/@shiro.hasPermission]
					<!--<dd>
							<a href="../preSellApply/list.jhtml" target="iframe">预售申请管理</a>
					</dd>  
					<dd>
							<a href="../presell/list.jhtml" target="iframe">预售活动设置</a>
					</dd>  
					<dd>
							<a href="../waterquality/list.jhtml" target="iframe">水质设置</a>
					</dd> --> 
                    ...
                    [@shiro.hasPermission name="admin:groupon"]
						<dd>
							<a href="../group/list.jhtml" target="iframe">团购管理</a>
						</dd>
                    [/@shiro.hasPermission]
					<!--
					<dd>
							<a href="../remind/list.jhtml" target="iframe">团购提醒管理</a>
					</dd>
					-->
				</dl>
				<dl id="statistics">
				...
				<dl id="system">
                    ...
                    [@shiro.hasPermission name="admin:store"]
						<dd>
							<a href="../store/list.jhtml" target="iframe">店铺管理</a>
						</dd>
                    [/@shiro.hasPermission]
                    ...
                    [@shiro.hasPermission name="admin:notice"]
						<dd>
							<a href="../notice/list.jhtml" target="iframe">站内公告</a>
						</dd>
                    [/@shiro.hasPermission]
					[@shiro.hasPermission name="admin:message"]
						<dd>
