...
<title>复制商品 - Powered By SHOP++</title>
...
<body>
	<div class="path">
		<a href="${base}/admin/common/index.jhtml">${message("admin.path.index")}</a> &raquo; 复制商品
	</div>
	<form id="inputForm" action="save.jhtml" method="post" enctype="multipart/form-data">
		...
		<table class="input tabContent">
			...
			<tr>
				...
				<td>
					<input type="text" name="sn" class="text" value="" maxlength="100" title="${message("admin.product.snTitle")}" />
				</td>
			</tr>
			<tr>
				<th>
			...
			<tr>
				...
				<td>
					<input type="text" name="stock" class="text" value="" maxlength="9" title="${message("admin.product.stockTitle")}" />
				</td>
			</tr>
			<tr>
				<th>
			...
			<tr>
				...
				<td>
					[#if store == null]
						<label>
							<input type="checkbox" name="isUseFenxiao" value="true" />是否分销
