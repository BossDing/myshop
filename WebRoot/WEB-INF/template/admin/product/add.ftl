	...
	<form id="inputForm" action="save.jhtml" method="post" enctype="multipart/form-data">
		...
		<table class="input tabContent">
			...
			<tr>
				...
				<td>
					<input type="text" name="orderNew" class="text" maxlength="9" />
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<input type="text" name="orderHot" class="text" maxlength="9" />
				</td>
			</tr>
			[/#if]
			<tr>
			...
			<tr>
				...
				<td>
					...
					<label class="hidden" id="all_checked_button">
			...
			<td>
					...
					[#assign x=x+1 /]
					[#if x%7==0]</br>[/#if]
						<input type="checkbox" name="area_name" value="${area.id}"/>${area.name}
					[/#list]
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					<span class="fieldSet">
						<input type="text" name="bigimage" class="text" maxlength="200" title="${message("admin.product.imageTitle")}" />
			...
			<tr>
				...
				<td>
					<span class="fieldSet">
						<input type="text" name="instruction" class="text" maxlength="200" title="${message("admin.product.imageTitle")}" />
			...
			<tr>
				...
				<td>
                    ...
                    <input type="hidden" name="checkStatus" value="success"/>
                    [#else]
                    <input type="hidden" name="isMarketable" value="false"/>[#-- 店铺商品默认未上架（等待审核） --]
                    <input type="hidden" name="checkStatus" value="waitting"/>
                    [/#if]
					<label>
			...
			<tr>
				...
				<td>
					<input type="text" name="lowPrice" class="text" maxlength="200" value="0"/>
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<input type="text" name="lowPoints" class="text" maxlength="200" value="0" />
				</td>
			</tr>
			<tr>
				<th>
		...
		<table class="input tabContent">
			<tr>
				<td>
					...
					<br>产品特征<br>
					<textarea id="editor2" name="features" class="editor" style="width: 100%;"></textarea>
					<br>产品外观<br>
					<textarea id="editor5" name="showimg" class="editor" style="width: 100%;"></textarea>
					<br>核心部件<br>
					<textarea id="editor3" name="core" class="editor" style="width: 100%;"></textarea>
					<br>用户体验<br>
					<textarea id="editor4" name="ue" class="editor" style="width: 100%;"></textarea>
				</td>
			</tr>
		</table>
