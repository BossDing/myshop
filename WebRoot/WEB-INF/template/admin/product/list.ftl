...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
	    [#if page.content?has_content]
	    	[#assign ENTCODE = page.content[0].entcode]
	    [/#if]
		<div class="path">
		...
		<form id="listForm" action="list.jhtml" method="get">
			...
			<table id="listTable" class="list">
				<tr>
					...
					[#if ENTCODE == "macrogw"]
					<th>
						<a href="javascript:;" class="sort" name="${tags.name}">官网 - 精品推荐</a>
					</th>
					<th>
						<a href="javascript:;" class="sort" name="${tags.name}">官网 - 新品</a>
					</th>
					<th>
						<a href="javascript:;" class="sort" name="${tags.name}">官网 - 热销</a>
					</th>
					<th>
						<a href="javascript:;" class="sort" name="order">${message("admin.common.order")}</a>
					</th>
					<th>
						<a href="javascript:;" class="sort" name="orderNew">排序-新品</a>
					</th>
					<th>
						<a href="javascript:;" class="sort" name="orderHot">排序-热销</a>
					</th>
					[/#if]
					<th>
	                ...
	                [#if ENTCODE == "macro"]
	                <th>
						<a href="javascript:;" class="sort" title="审核状态" name="checkStatus">状态</a>
					</th>
	                [/#if]
					<th>
				...
				[#list page.content as product]
					<tr>
						...
						[#if ENTCODE == "macro"]
	                    <td>
							[#if product.checkStatus == "waitting"]
								<span class="green">待审核</span>
	                        [#elseif product.checkStatus == "failure"]
	                        	<span class="red">未通过</span>
	                        [#elseif product.checkStatus == "success"]
						...
						<td>
							...
							<a href="copy.jhtml?id=${product.id}">[复制]</a>
