...
<body>
	<div class="path">
		<a href="${base}/admin/common/index.jhtml">${message("admin.path.index")}</a> &raquo; 体验中心<span>(${message("admin.page.total", page.total)})</span>
	</div>   
	<form id="listForm" action="list.jhtml" method="get">
		...
		<table id="listTable" class="list">
			<tr>
				...
				<th>
					<a href="javascript:;" class="sort" name="name">体验店名称</a>
				</th>
				<th>
					<a href="javascript:;" class="sort" name="title">营业时间</a>
				</th>
				<th>
					<a href="javascript:;" class="sort" name="beginDate">体验店地区</a>
				</th>
				<th>
					<a href="javascript:;" class="sort" name="endDate">详细地址</a>
				</th>
				<!--<th>
			...
			[#list page.content as promotion]
				<tr>
					...
					<td>
						<span title="体验店名称">${abbreviate(promotion.name, 50, "...")}</span>
					</td>
					<td>
						<span title="营业时间">${abbreviate(promotion.opentime, 50, "...")}</span>
					</td>
					<td>
						<span title="体验店地区">${abbreviate(promotion.areaName, 50, "...")}</span>
					</td>
					<td>
						<span title="详细地址">${abbreviate(promotion.address, 50, "...")}</span>
					</td>
					<!--
					<td>  
						${promotion.order}
