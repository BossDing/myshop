	...
	<form id="inputForm" action="save.jhtml" method="post">
		<table class="input">
			...
			<tr>
				...
				<td>
					<input type="text" name="subTitle" class="text" maxlength="200" />
				</td>
			</tr>
			<tr>
			<tr>
				...
				<td>
					<input type="text" name="subTitle2" class="text" maxlength="200" />
				</td>
			</tr>
			<tr>
				<th>
			...
			<tr>
				...
				<td>
					<input type="text" name="jobname" class="text" maxlength="200" />
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<input type="text" name="jobnumber" class="text" maxlength="200" />
				</td>
			</tr>
			<tr>
				<th>
