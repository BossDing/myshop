...
<body>
	...
	<form id="inputForm" action="update.jhtml" method="post">
		...
		<table class="input">
			...
			<tr>
				<th>
					<span class="requiredField"></span>副标题1:
				</th>
				<td>
					<input type="text" name="subTitle" class="text" value="${article.subTitle}" maxlength="200" />
				</td>
			</tr>
			<tr>
				<th>
					<span class="requiredField"></span>副标题2:
				</th>
				<td>
					<input type="text" name="subTitle2" class="text" value="${article.subTitle2}" maxlength="200" />
				</td>
			</tr>
			<tr>
				<th>
			...
			<tr>
				...
				<td>
					<input type="text" name="order" class="text" value="${article.order}" maxlength="9" />
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<input type="text" name="image" class="text" value="${article.image}" maxlength="200" />
			...
			<tr>
				...
				<td>
					<input type="text" name="jobname" class="text" value="${article.jobname}"  maxlength="200" />
				</td>
			</tr>
			<tr>		
				<th>
				...
				<td>
					<input type="text" name="jobnumber" class="text" value="${article.jobnumber}"  maxlength="200" />
				</td>
			</tr>
			<tr>
				<th>
