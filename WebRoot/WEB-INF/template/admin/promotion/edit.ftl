...
$().ready(function() {
	...
	$actionTypeId.val(${promotion.actionType.id});
	...
	<form id="inputForm" action="update.jhtml" method="post">
		...
		<div class="tabContent">
			<table class="input">
				...
				<tr>
					<th>
						${message("Promotion.shareSummary")}:
					</th>
					<td colspan="2">
						<input type="text" name="shareSummary" value="${promotion.shareSummary}" class="text" maxlength="250" />
					</td>
				</tr>
				<tr>
					<th>
					...
					<td colspan="2">
						<select name="actionTypeId" id="actionTypeId">
							[#list actionTypes as type]
								<option value="${type.id}">${type.actionName}</option>
							[/#list]
						</select>
					</td>
				</tr>
				<tr>
					...
					<td colspan="2">
						<select name="type" >
							<option value="0" [#if promotion.type==0]selected="selected"[/#if]>活动商品</option>
							<option value="1" [#if promotion.type==1]selected="selected"[/#if]>特惠促销商品</option>
						</select>
					</td>
				</tr>
				<tr>
				...
				<td>
					<span class="fieldSet">
						<input type="text" name="imgpath" id="imgpath" class="text" value="${promotion.imgpath}" maxlength="200" />
			...
			<tr>
				<th>
					<span class="requiredField">*</span>促销价:
				</th>
				<td>
					<input type="text" id="promotionPrice" value="${promotion.promotionPrice}" name="promotionPrice" class="text" maxlength="200" />
				</td>
			</tr>
				<tr>
					<th>
				...
				<tr class="productCategory">
					...
					<td colspan="2">
						...
						[#if productCategory.entcode=='macro']
							<label>
				...
				<tr>
					...
					<td colspan="2">
						...
						<label>
							<input type="checkbox" name="isUseCuXiao" value="true"[#if promotion.isUseCuXiao] checked="checked"[/#if] />是否同步促销
							<input type="hidden" name="_isUseCuXiao" value="false" />
						</label>
					</td>
				</tr>
			</table>
