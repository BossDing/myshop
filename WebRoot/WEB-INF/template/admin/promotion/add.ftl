		...
		<div class="tabContent">
			<table class="input">
				...
				<!--<tr>
					...
					<td colspan="2">
						<input type="text" name="shareSummary" class="text" maxlength="250" />
					</td>
				</tr>-->
				<tr>
					<th>
				...
				<tr>
					...
					<td colspan="2">
						<select name="type" >
							<option value="0">活动商品</option>
							<option value="1">特惠促销商品</option>
						</select>
					</td>
				</tr>
				<tr>
				...
				<td>
					<span class="fieldSet">
						<input type="text" name="imgpath" id="imgpath" class="text" value="" maxlength="200" />
			...
			<tr>
				...
				<td>
					<input type="text" id="promotionPrice" name="promotionPrice" class="text" maxlength="200" />
				</td>
			</tr>
				<tr>
					<th>
