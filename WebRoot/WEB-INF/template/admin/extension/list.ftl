...
<body>
	<div class="path">
		<a href="${base}/admin/common/index.jhtml">${message("admin.path.index")}</a> &raquo; 延保服务列表 <span>(${message("admin.page.total", page.total)})</span>
	</div>
	<form id="listForm" action="list.jhtml" method="get">
		...
		<table id="listTable" class="list">
			<tr>
				...
				<th>
					<a href="javascript:;" class="sort" name="cardNo">服务卡号</a>
				</th>
				<th>
					<a href="javascript:;" class="sort" name="userName">用户名</a>
				</th>
				<th>
					<a href="javascript:;" class="sort" name="barCode">条形码</a>
				</th>
				<th>
					<a href="javascript:;" class="sort" name="endDate">保修期</a>
				</th>
				<th>
			...
			[#list page.content as gr]
				<tr>
					...
					<td>
						<span title="${gr.sn}">${gr.sn}</span>
					</td>
					<td>
						<span title="${gr.cardNo}">${gr.cardNo}</span>
					</td>
					<td>
						<span title="${gr.userName}">${gr.userName}</span>
					</td>
					<td>
						<span title="${gr.barCode}">${gr.barCode}</span>
					</td>
					<td>
