...
<title>商品审核列表 - Powered By SHOP++</title>
	...
	<form id="listForm" action="list.jhtml" method="get">
		...
		<table id="listTable" class="list">
			<tr>
                ...
                --]
				<th>
					<a href="javascript:;" name="storeName">所属店铺</a>
				</th>
                [#--
				<th>
			...
			[#list page.content as product]
				<tr>
                    ...
                    --]
                    <td>
						<span title="所属店铺">${product.store.name}</span>
					</td>
                    [#--
					<td>
                        ...
                        [#if store == null]
	                        [#if product.checkStatus == "waitting"]
		                        <select name="checkStatus">
		                            ...
		                            <option value="F">驳回</option>
		                        </select>
		                        <input type="button" value="审核" onclick="check(this, ${product.id});"/>
	                        [/#if]
                        [/#if]
                        <a href="view.jhtml?id=${product.id}"><span>[查看]</span></a>
					</td>
				</tr>
			[/#list]
		</table>
