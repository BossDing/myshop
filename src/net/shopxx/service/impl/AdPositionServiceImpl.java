...
public class AdPositionServiceImpl extends BaseServiceImpl<AdPosition, Long> implements AdPositionService {
	...
	public AdPosition findByName(String Name) {
		return adPositionDao.findByName(Name);  
	}
	
	@Transactional
	public Page<AdPosition> findPage(Pageable pageable) {
		return adPositionDao.findPage(pageable);
	}
	...
	public AdPosition findNameByStore(String name, Store store) {
		return adPositionDao.findNameByStore(name, store);
	}
	
	@Transactional
	public List<AdPosition> findListForDeleteStore(Store store){
		return adPositionDao.findListForDeleteStore(store);
	}
}