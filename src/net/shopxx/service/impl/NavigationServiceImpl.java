...
public class NavigationServiceImpl extends BaseServiceImpl<Navigation, Long> implements NavigationService {
	...
	public List<Navigation> findList(Integer count, List<Filter> filters, List<Order> orders, Store store) {
		return navigationDao.findList(count, filters, orders, null, store);
	}
	...
	public List<Navigation> findListForDeleteStore(Store store){
		return navigationDao.findListForDeleteStore(store);
	}
