...
public class ArticleServiceImpl extends BaseServiceImpl<Article, Long> implements ArticleService, DisposableBean {
	...
	public Page<Article> findPageOrderBySetting(
		...
		// TODO Auto-generated method stub
		return articleDao.findPageOrderBySetting(articleCategory, tags, pageable);
	}
