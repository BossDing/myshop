...
public class ProductServiceImpl extends BaseServiceImpl<Product, Long>
	...
	public List<Product> findList(ProductCategory productCategory, Brand brand,
		...
		return productDao.findList(productCategory, brand, promotion, tags,
				attributeValue, startPrice, endPrice, isMarketable, isList,
				isTop, isGift, isOutOfStock, isStockAlert, orderType, count,
				filters, orders);
	}
	...
	public List<Product> findList(ProductCategory productCategory,
		...
		return productDao.findList(productCategory, beginDate, endDate, first,
				count);
	}
	...
	public Page<Product> findPage(ProductCategory productCategory, Brand brand,
		...
		return productDao.findPage(productCategory, brand, promotion, tags,
				attributeValue, startPrice, endPrice, isMarketable, isList,
				isTop, isGift, isOutOfStock, isStockAlert, orderType, pageable);
	}
	...
	public Page<Product> findPageByEntcode(ProductCategory productCategory,
			...
			Boolean isTop, Boolean isGift, Boolean isOutOfStock,
			Boolean isStockAlert, OrderType orderType, Pageable pageable) {
		return productDao.findPageByEntcode(productCategory, brand, promotion,
	...
	public Page<Product> findPageByCategoryList(List<ProductCategory> productCategorys, 
			...
			Boolean isTop, Boolean isGift, Boolean isOutOfStock,
			Boolean isStockAlert, OrderType orderType, Pageable pageable) {
		return productDao.findPageByCategoryList(productCategorys, brand, promotion,
				tags, attributeValue, startPrice, endPrice, isMarketable,
				isList, isTop, isGift, isOutOfStock, isStockAlert, orderType,
				pageable);
	}
	...
	public Long count(Member favoriteMember, Boolean isMarketable,
		...
		return productDao.count(favoriteMember, isMarketable, isList, isTop,
				isGift, isOutOfStock, isStockAlert);
	}
	...
	private void updateHits() {
		...
		for (Long id : ids) {
			...
			if (product != null) {
				...
				Calendar weekHitsCalendar = DateUtils.toCalendar(product
						.getWeekHitsDate());
				Calendar monthHitsCalendar = DateUtils.toCalendar(product
						.getMonthHitsDate());
	...
	public Page<Product> findNewListPage(Pageable pageable) {
		return productDao.findNewListPage(pageable);
	}

	// @Override
	public List<Product> findByItemSpec(String item) {
		return productDao.findByItemSpec(item);
	}

	public List<Product> findHotProductList(Integer count) {
		// TODO Auto-generated method stub
		return productDao.findHotProductList(count);
	}
	
	public List<Product> findHotProductListByCreateDate(Integer count) {
		return productDao.findHotProductListByCreateDate(count);
	}
	...
	public List<Product> searchForApp(String name) {
		return productDao.searchForApp(name);
	}
	...
	public Page<Product> findPageByEntcodeForCheck(
			...
			Pageable pageable) {
		return productDao.findPageByEntcodeForCheck(productCategory, brand,
				promotion, tags, attributeValue, startPrice, endPrice,
				isMarketable, isList, isTop, isGift, isOutOfStock,
				isStockAlert, orderType, pageable);
	}
	...
	@Override
	public Page<Product> findPageGW(ProductCategory productCategory, Brand brand,
			Promotion promotion, List<Tag> tags,
			Map<Attribute, String> attributeValue, BigDecimal startPrice,
			BigDecimal endPrice, Boolean isMarketable, Boolean isList,
			Boolean isTop, Boolean isGift, Boolean isOutOfStock,
			Boolean isStockAlert, OrderType orderType, Pageable pageable) {
		// TODO Auto-generated method stub
		return productDao.findPageGW(productCategory, brand, promotion, tags,
				attributeValue, startPrice, endPrice, isMarketable, isList,
				isTop, isGift, isOutOfStock, isStockAlert, orderType, pageable);
	}
	...
	public List<Product> findListGW(ProductCategory productCategory,
			...
			Boolean isStockAlert, OrderType orderType, Integer count,
			List<Filter> filters, List<Order> orders, String cacheRegion,
			Store store, Boolean px, Boolean px1) {
		// TODO Auto-generated method stub
		return productDao.findListGW(productCategory, brand, promotion, tags,
				attributeValue, startPrice, endPrice, isMarketable, isList,
				isTop, isGift, isOutOfStock, isStockAlert, orderType, count,
				filters, orders, store,px,px1);
	}
	...
	public List<Product> findListForDeleteStore(Store store){
		return productDao.findListForDeleteStore(store);
	}
}