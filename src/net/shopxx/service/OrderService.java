...
public interface OrderService extends BaseService<Order, Long> {
	 ...
	 * @return 订单分页
	 */
	Page<Order> findPage(String searchValue,Member member, Pageable pageable);
	 ...
	 * @return 商品分页
	 */
	Page<Order> findPage(OrderStatus orderStatus, PaymentStatus paymentStatus, ShippingStatus shippingStatus, Boolean hasExpired,String order, Pageable pageable);
	 ...
	 * @return 订单数量
	 */
	Long count(OrderStatus orderStatus, PaymentStatus paymentStatus, ShippingStatus shippingStatus, Boolean hasExpired,String order);
	 ...
	 * @return 等待发货订单数量
	 */
	Page<Order> waitingShipping(Member member, Pageable pageable);
	 ...
	 * @return 等待发货订单数量
	 */
	Long waitingGetCount(Member member);
	 ...
	 * @return 等待发货订单数量
	 */
	Page<Order> waitingReceiving(Member member, Pageable pageable);
	 ...
	 * @return 等待发货订单数量
	 */
	Long waitingConmentCount(Member member);
	 ...
	 * @return
	 */
	Order buildPointOrder(Product product, int quantity, Member member,
	 ...
	 * @return
	 */
    Order createJf(Product product, int quantity, Member member,Receiver receiver, PaymentMethod paymentMethod,
			ShippingMethod shippingMethod, CouponCode couponCode,boolean isInvoice, String invoiceTitle, boolean useBalance,String memo, Admin operator); 
	/**
	 * 创建订单
	 * 
	 * @param cart
	 ...
	 * @param operator
	 */
	void refundsJf(Order order, Refunds refunds, Admin operator);
	 ...
	 * @return 订单
	 */
	Order create(Cart cart, Receiver receiver, PaymentMethod paymentMethod, ShippingMethod shippingMethod, String receipt_Address, String nowtime, String duringtime, CouponCode couponCode, boolean isInvoice, String invoiceTitle, boolean useBalance, String memo, Admin operator);
	 ...
	 * @return 订单分页
	 */
	Page<Order> findUnpaidPage(Member member, Pageable pageable);
	
	/**
	 * 使用余额支付未付款的订单
	 * @Description 
	 * @author Guoxianlong
	 * @create_date Sep 17, 20143:44:52 PM
	 */
	 ...
	 * @return
	 */
	Page<Order> waitingConmentPage(Member member ,Pageable pageable);
