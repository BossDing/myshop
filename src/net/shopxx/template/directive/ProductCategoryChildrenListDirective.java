...
public class ProductCategoryChildrenListDirective extends BaseDirective {
	...
	/** "是否不递归子节点"参数名称 */
	private static final String DG_PARAMETER_NAME = "dg";
	...
	public void execute(Environment env, Map params, TemplateModel[] loopVars, TemplateDirectiveBody body) throws TemplateException, IOException {
		...
		Boolean dg = FreemarkerUtils.getParameter(DG_PARAMETER_NAME, Boolean.class, params);
		List<ProductCategory> productCategories;
		if(dg!=null && dg){
			boolean useCache = useCache(env, params);
			String cacheRegion = getCacheRegion(env, params);
			Integer count = getCount(params);
			productCategories = productCategoryService.findChildrenByParent(productCategoryId);
		}else{
