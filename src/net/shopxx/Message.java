...
public class Message {
	 ...
	 *            参数
	 */
	public Message(Type type, String content, Object objX) {
		this.type = type;
	 ...
	 * @return 成功消息
	 */
	public static Message success(String content, Object obj) {
		return new Message(Type.success, content, obj);
	}
	...
	public void setObjX(Object objX) {
		this.objX = objX;
	}
