...
/**
 * @description: 测试获取用户的等待收货的订单
 * @author: Guoxianlong
 * @date: Sep 4, 2014  9:40:56 AM
 */
public class TestGetWaitingReceivingOrder {
	/**
	 * @param args
	 */
	public static void main(String[] args) {
		...
		try {
			...
			strUrl = "http://m.emacro.cn/m/member/order/waitingReceivingOrder.jhtml";
...
//			strUrl += "?keycode=123456";
			...
			strTmp = "{'userid':'B285A686','pagenumber':'1','pagesize':'2'}";
