...
/**
 * @description: 测试查询 子分类 和 一级分类下的商品 或者 最后一个分类的商品
 * @author: Guoxianlong
 * @date: Sep 2, 2014 9:52:08 AM
 */
public class TestGetChildrenProductCategory {
	/**
	 * @param args
	 */
	public static void main(String[] args) {
		...
		try {
			...
			strUrl = "http://test.etwowin.com:9008/m/product_category/select.jhtml";
