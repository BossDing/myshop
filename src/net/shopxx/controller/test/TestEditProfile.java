...
public class TestEditProfile {
	...
	public static void main(String[] args) {
		...
		try {
			...
			strUrl = "http://test.etwowin.com:9008/m/member/profile/edit.jhtml";
...
//			strUrl += "?keycode=123456";
			...
			strTmp = "{'userid':'B2ABBA88B298C2C2','name':'test name','email':'guoxianlong@foxmail.com','mobile':'110','gender':'female','birth':'2014-1-1','areaid':'1992','address':'test address'}";
