...
/**
 * @description: 测试获取用户收藏的商品
 * @author: Guoxianlong
 * @date: Sep 4, 2014  9:40:56 AM
 */
public class TestGetFavorite {
	/**
	 * @param args
	 */
	public static void main(String[] args) {
		...
		try {
			...
			strUrl = "http://test.etwowin.com:9008/m/member/favorite/list.jhtml";
...
//			strUrl += "?keycode=123456";
			...
			strTmp = "{'userid':'B2ABBA88B298C2C2','username':'郭贤龙','password':'1234','checkcode':'9DA8B9959C92C786B2BBBACFB3ABBECAB3ABBE86B6BBBECAB095BE86B095BA85'}";
