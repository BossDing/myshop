...
/**
 * @description: 测试修改一个收货地址
 * @author: Guoxianlong
 * @date: Sep 4, 2014  9:40:56 AM
 */
public class TestEditReceiver {
	/**
	 * @param args
	 */
	public static void main(String[] args) {
		...
		try {
			...
			strUrl = "http://test.etwowin.com:9008/m/member/receiver/edit.jhtml";
...
//			strUrl += "?keycode=123456";
			...
			strTmp = "{'userid':'B2ABBA88B298C2C2','id':'3303','areaid':'1992','address':'工业大道','consignee':'test consignee','zipcode':'12345','isdefault':'true'}";
