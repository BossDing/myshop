...
public class TestCreateOrder {
	...
	public static void main(String[] args) {
		...
		try {
			...
			strUrl = "http://test.etwowin.com:9008/m/member/order/create.jhtml";
...
//			strUrl += "?keycode=123456";
			...
			strTmp = "{'userid':'B2ABBA88B298C2C2','receiverid':'4102','paymentmethodid':'1','shippingmethodid':'1'}";
