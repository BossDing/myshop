...
/**
 * @description: 测试查询 活动信息里面的商品
 * @author: Guoxianlong
 * @date: Sep 2, 2014 9:52:08 AM
 */
public class TestGetPromotionProducts {
	/**
	 * @param args
	 */
	public static void main(String[] args) {
		...
		try {
			...
			strUrl = "http://test.etwowin.com:9008/m/promotion/getPromotionProducts.jhtml";
			...
			strTmp = "{'id':'903','pagenumber':'1','pagesize':'10'}";
