...
/**
 * @description: 测试 获取所有精品推荐商品
 * @author: Guoxianlong
 * @date: Sep 1, 2014 9:52:08 AM
 */
public class TestGetCommendationProduct {
	/**
	 * @param args
	 */
	public static void main(String[] args) {
		...
		try {
			...
			strUrl = "http://test.etwowin.com:9008/m/product/getCommendationProducts.jhtml";
			...
			strTmp = "{'pagenumber':'1','pagesize':'10'}";
