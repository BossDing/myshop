...
/**
 * @description: 测试删除一个收货地址
 * @author: Guoxianlong
 * @date: Sep 4, 2014  9:40:56 AM
 */
public class TestDeleteReceiver {
	/**
	 * @param args
	 */
	public static void main(String[] args) {
		...
		try {
			...
			strUrl = "http://test.etwowin.com:9008/m/member/receiver/delete.jhtml";
...
//			strUrl += "?keycode=123456";
			...
			strTmp = "{'userid':'B2ABBA88B298C2C2','id':'3201'}";
