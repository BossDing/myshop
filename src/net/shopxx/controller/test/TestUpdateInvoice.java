...
/**
 * @description: 测试更改用户发票信息
 * @author: Guoxianlong
 * @date: Sep 4, 2014  9:40:56 AM
 */
public class TestUpdateInvoice {
	/**
	 * @param args
	 */
	public static void main(String[] args) {
		...
		try {
			...
			strUrl = "http://test.etwowin.com:9008/m/member/profile/saveinvoice.jhtml";
...
//			strUrl += "?keycode=123456";
			...
			strTmp = "{'userid':'B2ABBA88B298C2C2','name':'test dangwei name','id':'FASDGFE','address':'test address','phone':'46789787','bank':'test bank','account':'test account'}";
