...
/**
 * @description: 测试获取用户待付款的订单
 * @author: Guoxianlong
 * @date: Sep 4, 2014  9:40:56 AM
 */
public class TestGetWaitingPaymentOrder {
	/**
	 * @param args
	 */
	public static void main(String[] args) {
		...
		try {
			...
			strUrl = "http://test.etwowin.com:9008/m/member/order/waitingPaymentOrder.jhtml";
...
//			strUrl += "?keycode=123456";
			...
			strTmp = "{'userid':'B2ABBA88B298C2C2','pagenumber':'1','pagesize':'2'}";
