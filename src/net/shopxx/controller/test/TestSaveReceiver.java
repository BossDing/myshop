...
/**
 * @description: 测试添加一个收货地址
 * @author: Guoxianlong
 * @date: Sep 4, 2014  9:40:56 AM
 */
public class TestSaveReceiver {
	/**
	 * @param args
	 */
	public static void main(String[] args) {
		...
		try {
			...
			strUrl = "http://test.etwowin.com:9008/m/member/receiver/save.jhtml";
...
//			strUrl += "?keycode=123456";
			...
			strTmp = "{'userid':'B2ABBA88B298C2C2','areaid':'1993','address':'test address','consignee':'test_user','zipcode':'341400','phone':'13879704912','isdefault':'true'}";
