...
public class TestGetProductReview {
	...
	public static void main(String[] args) {
		...
		try {
			...
			strUrl = "http://test.etwowin.com:9008/m/member/order/getproductreview.jhtml";
...
//			strUrl += "?keycode=123456";
			...
			strTmp = "{'userid':'B2ABBA88B298C2C2','sn':'2014091810807','pagenumber':'1','pagesize':'10'}";
