...
/**
 * @description: 测试使用余额支付订单
 * @author: Guoxianlong
 * @date: Sep 4, 2014  9:40:56 AM
 */
public class TestPaymentOrderUseBalance {
	/**
	 * @param args
	 */
	public static void main(String[] args) {
		...
		try {
			...
			strUrl = "http://m.emacro.cn/m/member/order/payment.jhtml";
...
//			strUrl += "?keycode=123456";
			...
			strTmp = "{'userid':'B285A686','sn':'2014103011413','usebalance':'true'}";
