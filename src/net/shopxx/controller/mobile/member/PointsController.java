 ...
 * @version 3.0
 */
@Controller("mobileMemberPointsController")
@RequestMapping("/mobile/member/points")
public class PointsController extends BaseController {
	...
	public String list(String rulename, String name, ModelMap model) {
		System.out.println("--1--");
		Member member = memberService.getCurrent();
		System.out.println("--2--");
		model.addAttribute("member",member);
		model.addAttribute("pointsWater",pointsWaterService.findList(member));
		return "/mobile/member/points/list";
	}
}