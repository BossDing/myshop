 ...
 * @version 3.0
 */
@Controller("mobileCouponCodeController")
@RequestMapping("/mobile/member/coupon_code")
public class CouponCodeController extends BaseController {
	...
	public String exchange(Integer pageNumber, ModelMap model) {
		...
		return "mobile/member/coupon_code/exchange";
	}
	...
	public String list(ModelMap model) {
		Member member = memberService.getCurrent();
		model.addAttribute("page", couponCodeService.findAll());
		return "mobile/member/coupon_code/list";
	}
	...
	public @ResponseBody ModelMap listAll(ModelMap model) {
		Member member = memberService.getCurrent();
		return model.addAttribute("page", couponCodeService.findAll());
	}
