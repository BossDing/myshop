...
public class CouponCodeController extends BaseController {
	...
	public String list(Integer pageNumber, ModelMap model) {
		Member member = memberService.getCurrent();     				
		Pageable pageable = new Pageable(pageNumber, PAGE_SIZE);
		model.addAttribute("all", couponCodeService.count(null, member, null, null, null));
		model.addAttribute("used", couponCodeService.count(null, member, null, null, true));
		model.addAttribute("unused", couponCodeService.count(null, member, null, null, false));
		model.addAttribute("expired", couponCodeService.count(null, member, null, true, null));
