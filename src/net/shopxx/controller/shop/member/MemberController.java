...
public class MemberController extends BaseController {
	...
	public String index(Pageable pageable ,Integer pageNumber, ModelMap model) {
		...
		model.addAttribute("messages", messageService.findReceiverPage(member, pageable));
		model.addAttribute("notices", noticeService.findPublishedPage(pageable));
