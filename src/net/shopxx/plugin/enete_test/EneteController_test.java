 ...
 * @version 3.0
 */
@Controller("adminEneteControllerTest")
@RequestMapping("/admin/payment_plugin/enete_test")
public class EneteController_test extends BaseController {
	@Resource(name = "enetePluginTest")
	private EnetePlugin_test enetePlugin;
	...
	public @ResponseBody
	Message install() {
		if (!enetePlugin.getIsInstalled()) {
			PluginConfig pluginConfig = new PluginConfig();
			pluginConfig.setPluginId(enetePlugin.getId());
	...
	Message uninstall() {
		if (enetePlugin.getIsInstalled()) {
			PluginConfig pluginConfig = enetePlugin.getPluginConfig();
	...
	public String setting(ModelMap model) {
		...
		return "/net/shopxx/plugin/enete_test/setting";
	}
