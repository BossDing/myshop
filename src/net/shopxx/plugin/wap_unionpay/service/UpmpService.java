package net.shopxx.plugin.wap_unionpay.service;

import java.util.Map;

import net.shopxx.plugin.wap_unionpay.conf.UpmpConfig;
import net.shopxx.plugin.wap_unionpay.util.HttpUtil;
import net.shopxx.plugin.wap_unionpay.util.UpmpCore;
...
public class UpmpService{
	...
	public static String tradeX(Map<String, String> req) {
		String nvp = buildReq(req);
		String respString = HttpUtil.post(UpmpConfig.TRADE_URL, nvp);
		return respString;
	}
	public static boolean tradeY(String respString, Map<String, String> resp) {
		return verifyResponse(respString, resp);
	}
