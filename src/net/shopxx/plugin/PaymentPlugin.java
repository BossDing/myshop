...
public abstract class PaymentPlugin implements Comparable<PaymentPlugin> {
	...
	/**
	 * @author Guoxianlong
	 * @date Oct 29, 2014 3:12:15 PM
	 */
	public PluginConfig getPluginConfig(Store store) {
		return pluginConfigService.findByPluginId(getId(), store);
	}
	 ...
	 * @return 请求参数
	 */
	public abstract Map<String, Object> getParameterMap(String sn, String description, HttpServletRequest request, Store store);
	/**
	 * 验证通知是否合法
	 * 
	 * @param sn
	 ...
	 * @return 通知是否合法
	 */
	public abstract boolean verifyNotify(String sn, NotifyMethod notifyMethod, HttpServletRequest request, Store store);
	/**
	 * 获取通知返回消息
	 * 
	 * @param sn
