...
import net.shopxx.util.app.alipay.sign.RSA;
import net.shopxx.util.app.alipay.util.httpClient.HttpProtocolHandler;
import net.shopxx.util.app.alipay.util.httpClient.HttpRequest;
import net.shopxx.util.app.alipay.util.httpClient.HttpResponse;
import net.shopxx.util.app.alipay.util.httpClient.HttpResultType;
