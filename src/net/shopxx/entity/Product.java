...
public class Product extends OrderEntity {
	...
	/** 官网静态路径 */
	private static String gwStaticPath;
	
	/**积分商城静态路径*/
	private static String pointStaticPath;
	...
	/** 覆盖区域 */
	private Set<AfterBooking> afterBookings = new HashSet<AfterBooking>();
	
	
//	private Set<ServiceRegister> serviceRegisters = new HashSet<ServiceRegister>();
	...
	/** 店铺新增商品，审核状态(店铺新增商品，增加审核功能)*/
	private CheckStatus checkStatus;
	
	/** 是否允许分销  商城管理员控制 **/
	private Boolean isUseFenxiao;
	 ...
	 * 本商品意指派到的店铺
	 */
	private Set<net.shopxx.entity.Store> assignedStores  = new HashSet<net.shopxx.entity.Store>();
	...
	static {
		try {
			...
			org.dom4j.Element mobileelement = (org.dom4j.Element) document.selectSingleNode("/shopxx/template[@id='mobileProductContent']");
			org.dom4j.Element pointelement = (org.dom4j.Element) document.selectSingleNode("/shopxx/template[@id='pointProductContent']");
			org.dom4j.Element gwelement = (org.dom4j.Element) document.selectSingleNode("/shopxx/template[@id='gwProductContent']");
			staticPath = element.attributeValue("staticPath");
			pointStaticPath= pointelement.attributeValue("staticPath");
			mobileStaticPath = mobileelement.attributeValue("staticPath");
			gwStaticPath = gwelement.attributeValue("staticPath");
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	 ...
	 *            编号
	 */
	public void setEshopsn(String eshopsn) {
		this.eshopsn = eshopsn;
	}
	...
	public String getIntroduction() {
		return introduction == null ? null : introduction.replaceAll(">\\s*[•？]+", ">")
				.replaceAll(">\\s*(\\&bull;)+", ">");//cgd 2014-11-12 万家乐官网商品介绍"•""?"替换
	}
	...
	public void setIntroduction(String introduction) {
		this.introduction = introduction == null ? null : introduction.replaceAll(">\\s*[•？]+", ">")
				.replaceAll(">\\s*(\\&bull;)+", ">");//cgd 2014-11-12 万家乐官网商品介绍"•""?"替换
	}
	...
	public String getShowimg() {
		return showimg == null ? null : showimg.replaceAll(">\\s*[•？]+", ">")
				.replaceAll(">\\s*(\\&bull;)+", ">");//cgd 2014-11-12 万家乐官网商品介绍"•""?"替换
	}
	...
	public void setShowimg(String showimg) {
		this.showimg = showimg == null ? null : showimg.replaceAll(">\\s*[•？]+", ">")
				.replaceAll(">\\s*(\\&bull;)+", ">");//cgd 2014-11-12 万家乐官网商品介绍"•""?"替换
	}
	...
	@Lob
	public String getUe() {
		return ue == null ? null : ue.replaceAll(">\\s*[•？]+", ">")
				.replaceAll(">\\s*(\\&bull;)+", ">");//cgd 2014-11-12 万家乐官网商品介绍"•""?"替换
	}
	...
	public void setUe(String ue) {
		this.ue = ue == null ? null : ue.replaceAll(">\\s*[•？]+", ">")
				.replaceAll(">\\s*(\\&bull;)+", ">");//cgd 2014-11-12 万家乐官网商品介绍"•""?"替换
	}
	...
	public String getCore() {
		return core == null ? null : core.replaceAll(">\\s*[•？]+", ">")
				.replaceAll(">\\s*(\\&bull;)+", ">");//cgd 2014-11-12 万家乐官网商品介绍"•""?"替换
	}
	...
	public void setCore(String core) {
		this.core = core == null ? null : core.replaceAll(">\\s*[•？]+", ">")
				.replaceAll(">\\s*(\\&bull;)+", ">");//cgd 2014-11-12 万家乐官网商品介绍"•""?"替换
	}
	...
	public String getFeatures() {
		return features == null ? null : features.replaceAll(">\\s*[•？]+", ">")
				.replaceAll(">\\s*(\\&bull;)+", ">");//cgd 2014-11-12 万家乐官网商品介绍"•""?"替换
	}
	...
	public void setFeatures(String features) {
		this.features = features == null ? null : features.replaceAll(">\\s*[•？]+", ">")
				.replaceAll(">\\s*(\\&bull;)+", ">");//cgd 2014-11-12 万家乐官网商品介绍"•""?"替换
	}
	 ...
	 */
	@ManyToMany(fetch = FetchType.LAZY)
	@JoinTable(name = "xx_coverage_area")
	 ...
	 */	
	@ManyToMany(mappedBy = "products", fetch = FetchType.LAZY)
	public Set<AfterBooking> getAfterBookings() {
		return afterBookings;
	}

	public void setAfterBookings(Set<AfterBooking> afterBookings) {
		this.afterBookings = afterBookings;
	}
...
//	}
//
//	public void setServiceRegisters(Set<ServiceRegister> serviceRegisters) {
...
//	}
	...
	public String getGwPath() {
		...
		model.put("productCategory", getProductCategory());
		try {
			return FreemarkerUtils.process(gwStaticPath, model);
		} catch (IOException e) {
			e.printStackTrace();
		} catch (TemplateException e) {
			e.printStackTrace();
	 ...
	 *   
	 * 获取手机端访问路径
	 * 静态手机端商城 edit by xiaolai 2014-04-18
	 * @return 访问路径
	 */
	@JsonProperty
	@Transient
	...
	public String getPointPath() {
		...
		model.put("productCategory", getProductCategory());
		try {
			return FreemarkerUtils.process(pointStaticPath, model);
		} catch (IOException e) {
			e.printStackTrace();
		} catch (TemplateException e) {
			e.printStackTrace();
	 ...
	 */
	@Transient
	private BigDecimal getTempProductPrice(Promotion promotion) {
		BigDecimal tempPrice = new BigDecimal(0);
		tempPrice = tempPrice.add(getPrice().multiply(new BigDecimal(1)));
		return tempPrice;
	}
	...
	public BigDecimal getProductDiscount() {
		...
		if(getProductCategory() != null){
			if(getProductCategory().getPromotions() != null){
				for(Promotion promotion:getProductCategory().getPromotions()){
					if (promotion != null) {
						int promotionQuantity = 1;
						BigDecimal originalPromotionPrice = getTempProductPrice(promotion);
	...
	public BigDecimal getDiscountPrice() {
		BigDecimal discountPrice = getPrice().subtract(getProductDiscount());
		return discountPrice.compareTo(new BigDecimal(0)) > 0 ? discountPrice : new BigDecimal(0);
	}
...
//	@Column(nullable = false)
	...
	@Column
	public Boolean getIsUseFenxiao() {
		return isUseFenxiao;
	}

	public void setIsUseFenxiao(Boolean isUseFenxiao) {
		this.isUseFenxiao = isUseFenxiao;
	}
	...
	@Field(store = Store.YES, index = Index.UN_TOKENIZED)
	@Min(0)
	@Column(name = "orderhot")
	public Integer getOrderHot() {
		return orderHot;
	}
	 ...
	 *            排序2
	 */
	public void setOrderHot(Integer orderHot) {
		this.orderHot = orderHot;
	}
	 ...
	 *            排序3
	 */
	public void setOrderNew(Integer orderNew) {
	 ...
	 */
	@ManyToMany(fetch = FetchType.LAZY)
	@JoinTable(name = "xx_assigned_product_store")
	public Set<net.shopxx.entity.Store> getAssignedStores() {
	 ...
	 * @param assignedStore
	 */
	public void setAssignedStores(Set<net.shopxx.entity.Store> assignedStores) {
