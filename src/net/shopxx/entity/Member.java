...
public class Member extends BaseEntity {
	...
	/** 银行账号 */
	private String yinghanzhanghao;
	...
	/**买家留言*/
	private Set<LeaveWords> leaveWordsSet = new HashSet<LeaveWords>();
	
	/**
	 * 微信会员id（一个14为的随机序列）
	 */
	private String wechatVipId;
	
	
	@OneToMany(mappedBy = "member", fetch = FetchType.LAZY, cascade = CascadeType.REMOVE)
	@OrderBy("createDate desc")
	public Set<LeaveWords> getLeaveWordsSet() {
		return leaveWordsSet;
	}
	public void setLeaveWordsSet(Set<LeaveWords> leaveWordsSet) {
		this.leaveWordsSet = leaveWordsSet;
	}
	/**
	 * 获取头像
	 * @return
